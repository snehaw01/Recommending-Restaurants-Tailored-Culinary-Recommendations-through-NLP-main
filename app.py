...
def connect():
    ...
    df['image_url'] = df['image_url'].fillna("/Users/snehaw/Downloads/Recommending-Restaurants-Tailored-Culinary-Recommendations-through-NLP-main/Yellow Emblem Restaurant Logo.png")
...
def main():
    ...
    st.title("FoodFinder: Discover Your Next Favorite Restaurant")
